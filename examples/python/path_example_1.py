...
path_id_2.append(
    ocl.Line(ocl.Point(19.62435565, 5.99038106, 0), ocl.Point(4.62435565, 19.99038106, 0))
)
...
path_id_2.append(
    ocl.Line(ocl.Point(-19.6243556, -5.99038106, 0), ocl.Point(-4.62435565, -19.9903811, 0))
)
...
path_id_3.append(
    ocl.Arc(
        ocl.Point(-18, 18, 0),
        ocl.Point(-10.00000001, 21.99999996, 0),
        ocl.Point(-11.0434783, 14.08695652, 0),
        True,
    )
)
...
for path in paths:
    ...
    for span in spans:
        ...
        if span_type == ocl.ArcSpanType:
            arc = span_element
            print(
                "Arc(start=" + str(arc.p1) + ", centre=" + str(arc.c) + " end=" + str(arc.p2) + ")"
            )
