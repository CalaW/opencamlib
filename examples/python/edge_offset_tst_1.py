...
if __name__ == "__main__":
    ...
    # tube
    cyltube = camvtk.Tube(
        p1=(a.x, a.y, a.z), p2=(b.x, b.y, b.z), radius=diameter / 2, color=camvtk.yellow
    )
    ...
    drawEdge(myscreen, a, b)
    cir1 = camvtk.Circle(
        center=(a.x, a.y, a.z), radius=diameter / 2, color=camvtk.lgreen, resolution=50
    )
    cir1.SetOpacity(1)
    myscreen.addActor(cir1)
    cir2 = camvtk.Circle(
        center=(b.x, b.y, b.z), radius=diameter / 2, color=camvtk.pink, resolution=50
    )
    cir2.SetOpacity(1)
