...
void Point::matrixRotate(double a, double b, double c, double d, double e, double f, double g,
                         double h, double i) {
...
const Point Point::operator*(const double& a) const { return Point(*this) *= a; }
