...
CLPoint::CLPoint() : Point() { cc = new CCPoint(); }

CLPoint::CLPoint(double x, double y, double z) : Point(x, y, z) { cc = new CCPoint(); }

CLPoint::CLPoint(double x, double y, double z, CCPoint& ccp) : Point(x, y, z) {
    cc = new CCPoint(ccp);
}

CLPoint::CLPoint(const CLPoint& cl) : Point(cl.x, cl.y, cl.z) { cc = new CCPoint(*cl.cc); }

CLPoint::CLPoint(const Point& p) : Point(p.x, p.y, p.z) { cc = new CCPoint(); }

CLPoint::~CLPoint() { delete cc.load(); }
...
CCPoint CLPoint::getCC() { return *cc; }
