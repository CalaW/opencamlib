...
public:
    ...
    bool update_ifCCinEdgeAndTrue(double t_cl, CCPoint& cc_tmp, const Point& p1, const Point& p2,
                                  bool condition);
    ...
    CCPoint
        upper_cc; ///< cutter contact points at upper and lower are stored in upper_cc and lower_cc
    ...
    typedef boost::adjacency_list_traits<boost::listS, boost::listS, boost::bidirectionalS,
