...
/// \brief a Waterline toolpath follows the shape of the model at a constant z-height in the
/// xy-plane

/// The Waterline object is used for generating waterline or z-slice toolpaths
/// from an STL-model. Waterline uses two BatchPushCutter sub-operations to find out where the
/// CL-points are located and a Weave to split and order the CL-points correctly into loops.
