...
// this figure illustrates next-pointers:
// http://www.anderswallin.net/wp-content/uploads/2011/05/weave2_zoom.png
void Weave::face_traverse() {
    ...
    while (!clVertexSet.empty()) { // while unprocessed cl-vertices remain
        ...
        do {                               // traverse around the loop
            ...
            assert(outEdges.size() ==
                   1); // cl-points are always at ends of intervals, so they have only one out-edge
