...
public:
    ...
    /// Cone facet-drop is special, since we can make contact with either the tip or the circular
    /// rim
...
protected:
    ...
    bool cone_CC(const Point& tang, const Point& tip, const Point& base, const Point& p1,
